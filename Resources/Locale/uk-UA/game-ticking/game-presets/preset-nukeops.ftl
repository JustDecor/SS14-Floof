...
nukeops-welcome =
    Ти ядерний оперативник. Твоя мета - підірвати {$station} та переконатися, що від неї залишиться лише купа руїн. Твої боси, Синдикат, надали тобі інструменти, необхідні для цього завдання.
    Операція {$name} почалася! Смерть Нанотрасену!
